...
public class CollitionHandler implements Runnable {
	...
	private final int HITBOX_LIGHT_PUNCH_X = 110;
	private final int HITBOX_HARD_PUNCH_X = 120;
	private final int HITBOX_LIGHT_PUNCH_Y = 80;
	private final int HITBOX_HARD_PUNCH_Y = 50;
	private final int HITBOX_LIGHT_KICK_X = 160;
	private final int HITBOX_LIGHT_KICK_Y = 50;
	private final int HITBOX_HARD_KICK_X = 170;
	private final int HITBOX_HARD_KICK_Y = 80;
				...
				if (player1.isLightPunching()) {
					...
					if (blowPlayer1.intersects(p2HitBox)) {
						if ((!player2.combat.blocking()) || (player2.combat.blocking() && player1.getDirection() == player2.getDirection())) {
							...
							System.out.println("DUDE WTF " + player2.getHp());
